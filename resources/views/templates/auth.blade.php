...
<div class="flex flex-col min-h-full justify-between">
    ...
    <div id="header-border" class="w-full pb-1 mb-10">
        <div id="header" class="w-full p-4">
            <div class="container mx-auto text-white px-10 font-bold flex">
    ...
    <div class="container mx-auto px-6">
        <div id="card" class="max-w-lg bg-white shadow-lg mx-auto rounded-b-lg">
    ...
    <!-- Footer -->
    <div class="container mx-auto px-6 text-xs text-center py-2">
