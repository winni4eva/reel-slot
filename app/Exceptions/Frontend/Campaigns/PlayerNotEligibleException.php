...
class PlayerNotEligibleException extends Exception
{
    /**
     * @var Campaign
     */
    ...
    public function render()
    {
        ...
        $text = $this->campaign->texts()->where('name', 'player_not_eligible')->first();

        // Add message to base config
        $config['error'] = $text->value ?? 'player_not_eligible';
